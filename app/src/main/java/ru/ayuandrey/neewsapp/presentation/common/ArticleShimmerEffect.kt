...
@Composable
fun ArticleCardShimmerEffect(modifier: Modifier = Modifier) {         //Эффект мерцания карточки товара / серые квадратики
    Row(
        modifier = modifier
    ) {
        Box(
